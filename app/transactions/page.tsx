...
export default function TransactionsPage() {
  ...
  const loadTransactions = async () => {
    ...
    setIsLoading(true);
    try {
      const { transactions: dbTransactions, error } =
        await getFamilyTransactions(family.id);
      if (error) {
  ...
  useEffect(() => {
    ...
    if (filters.categoryFilter) {
      filtered = filtered.filter(
        (t) => t.category_id === filters.categoryFilter,
      );
    }
    ...
    if (filters.typeFilter) {
      filtered = filtered.filter(
        (t) => t.transaction_type === filters.typeFilter,
      );
    }
  ...
  const handleCreateTransaction = async () => {
    ...
    try {
      ...
      const { transaction: newDbTransaction, error } = await createTransaction(
        transactionData,
        family.id,
      );
      if (error) {
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setNewTransaction({ ...newTransaction, goal_id: value })
                    }
                  >
                    <SelectTrigger className="col-span-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handleFilterChange("accountFilter", value)
                }
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handleFilterChange("goalFilter", value)
                }
              >
                <SelectTrigger>
                    ...
                    <div className="px-4 py-4 sm:px-6">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="ml-2 flex-shrink-0 flex">
                          <p
                            className={`text-sm ${transaction.transaction_type === "income" ? "text-green-600" : "text-red-600"} font-semibold`}
                          >
